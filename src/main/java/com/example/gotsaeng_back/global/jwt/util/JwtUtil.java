package com.example.gotsaeng_back.global.jwt.util;
...
public class JwtUtil {
    ...
    //token create
    private String createToken(Long id , String email  , String username , RoleType role , Long expire , byte[] secretKey){
    ...
    //AccessToken생성
    public String createAccessToken(Long id , String email , String username , RoleType role){
        return createToken(id,email , username ,role,ACCESS_TOKEN_EXPIRE_COUNT,accessSecret);
    }
    //RefreshToken생성
    public String createRefreshToken(Long id , String email , String username , RoleType role ){
